...
export const ChartComponents: ChartMap = {
  TimeRangeChart: defineAsyncComponent(() => import('../components/chart/TimeRangeChart.vue')),
  ...
  TimelineChart: defineAsyncComponent(() => import('../components/chart/types/TimelineChart.vue')),
