...
//     history: (state: AppConfigModuleState) => (): HistorySettingsType => state.appConfig.hub.history,
//     logger: (state: AppConfigModuleState) => (): LoggerSettingsType => state.appConfig.hub.logger,
