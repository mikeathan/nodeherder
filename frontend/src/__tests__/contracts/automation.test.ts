...
function automationData1IsEqualToDeserializedObject() {
    ...
    isEqualToValueAndNotNull(automation_data1, "friendlyname", newAutomaton.friendlyname);
    isEqualToValueAndNotNull(automation_data1, "description", newAutomaton.description);
...
function automationData2IsEqualToDeserializedObject() {
    ...
    isEqualToValueAndNotNull(automation_data2, "friendlyname", newAutomaton.friendlyname);
    isEqualToValueAndNotNull(automation_data2, "description", newAutomaton.description);
