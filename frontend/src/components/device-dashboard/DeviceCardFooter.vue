...
<template>
  <div class="card-footer">
    <div class="row justify-content-between flex-nowrap">
      <LastSeen :id="payload.id" :value="payload.stats.last_seen"></LastSeen>
      ...
      <div className="col-auto text-truncate" v-else>
        <i title="offline">
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-wifi-off"
            viewBox="0 0 24 24">
            <path
