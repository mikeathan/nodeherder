...
function removeDevice(event: string) {
...
<template>
  ...
  <RenameDeviceDialog :friendlyName="device.friendly_name" :show="showRenameDialog" @update:name="renameDevice"
  ...
  <RemoveDeviceDialog :friendlyName="device.friendly_name" :show="showRemoveDialog" @remove="e => removeDevice(e)"
