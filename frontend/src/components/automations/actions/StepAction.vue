<script setup lang="ts">
  ...
  import { AutomationActionStep, NumericOperator, AutomationStepAction } from '@/types/automation';
      ...
      <Column header="Device">
        <template #body="slotProps">
          <div v-if="slotProps.data.id == ''" style="display: flex; align-items: center; gap: 0.5rem">
            <DeviceSelector
              @updated="(id, name) => stepDeviceSelected(id, slotProps.data)"
        ...
        <template #body="slotProps">
          <div style="display: flex; align-items: center; gap: 0.5rem">
            <ExposeSelector
              ...
              @updated="(v) => stepPropertySelected(v, slotProps.data)"
